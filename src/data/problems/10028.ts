  ...
  "solutions": [
    {
      ...
      "label": "裂项相消法",
      "steps": [
        "观察分母的结构：2=1×2， 6=2×3， 12=3×4， 20=4×5， 30=5×6，每个分母都是两个相邻整数的乘积。",
        "裂项公式：1/(n × (n + 1)) = 1/n − 1/(n + 1)，即一个分数可以写成两个相邻单位分数的差。",
        "把每一项按公式分裂：1/2 = 1 − 1/2， 1/6 = 1/2 − 1/3， 1/12 = 1/3 − 1/4， 1/20 = 1/4 − 1/5， 1/30 = 1/5 − 1/6。",
        "相加后，中间的 1/2、1/3、1/4、1/5 都一正一负互相抵消，只剩下首项 1 与尾项 −1/6。",
        "原式 = 1 − 1/6 = 5/6。"
      ],
      "scenes": [
        {
