  ...
  "solutions": [
    {
      ...
      "label": "线段图法",
      "steps": [
        "分析：父子年龄差 d 始终不变。把四个关键年龄按时间先后排在一条数轴上：过去儿子 3 岁、现在儿子、现在父亲、未来父亲 78 岁。相邻两点恰好都相差一个 d（因为「过去父亲 = 现在儿子」、「现在父亲 = 未来儿子」），从 3 到 78 正好是 3 个 d。",
        "3d = 78 − 3 = 75 ⇒ d = 25；儿子现在 3 + 25 = 28 岁，父亲现在 28 + 25 = 53 岁。"
      ],
      "scenes": [
        {
          "kind": "number-line",
