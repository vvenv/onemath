  ...
  "solutions": [
    {
      ...
      "label": "隔板法",
      "steps": [
        "分析：苹果相同（不用区分哪个给哪个，只关心“每人几个”），小朋友不同；还要求每人至少 1 个。相同物品的分配问题可以用“在物品之间插挡板分段”来计数。",
        "把 10 个相同的苹果排成一排：🍎🍎🍎🍎🍎🍎🍎🍎🍎🍎。",
        "苹果之间形成 9 个空隙（两端不算，因为每人至少要分到 1 个）。",
        "要把苹果分给 3 个小朋友，只需在这 9 个空隙中放入 2 块相同的隔板，把苹果切成 3 段。",
        "每一种放隔板的方式对应一种分法：从 9 个位置里选 2 个放隔板，共 C(9, 2) 种。",
        "计算：C(9, 2) = 9 × 8 ÷ 2 = 36，所以一共有 36 种不同的分法。"
      ],
      "scenes": [
        {
          "kind": "svg",
