  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "分析：锅每次只能烙 2 张饼，每张饼烙两面。要让锅尽可能不空。",
        },
        {
          text: "前 3 张用交替烙法需 3 × 3 = 9 分钟，后 4 张两两烙需 (4 ÷ 2) × 6 = 12 分钟。",
        },
        {
          text: "总时间 = 9 + 12 = 21 分钟。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "前 3 张（交替）", rhs: "3 × 3 = 9", note: "分钟" },
            ...
            },
            {
              kind: "compare-bars",
              rows: [
                { label: "交替烙 3 张", value: 9, max: 21, tone: "primary" },
    ...
    },
    {
      ...
      steps: [
        {
          text: "分析：单数饼的最优策略是前 3 张用交替烙法，其余用两两烙法。",
        },
        {
          text: "前 3 张交替烙需要 3 × 3 = 9 分钟。",
        },
        {
          text: "后 4 张两两烙需要 (4 ÷ 2) × 6 = 12 分钟。",
        },
        {
          text: "总时间 = 9 + 12 = 21 分钟。",
          scenes: [
