...
export default {
  ...
  module: "杂题",
  question:
    "如图，大圆周上均匀分布 6 个位置 A, B, C, D, E, F，圆心 O 是第 7 个位置；AD、BE、CF 为 3 条直径。把 1–7 各用一次填入这 7 个位置，要求：\n\n(A) 每条直径上 3 个数（两端 + 圆心）之和都相等；\n(B) 圆周 6 个数之和等于 21。\n\n求圆心 O 填几？每条直径的公共和 S 是多少？",
  figures: [
    {
      svg: svg1,
  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "分析：设圆心 O 填 c。由 1+2+…+7 = 28，圆周 6 数之和 = 28 − c。",
        },
        {
