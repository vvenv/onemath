  ...
  "solutions": [
    {
      ...
      "label": "代换消元",
      "steps": [
        "分析：记独脚兽 a、双头龙 b、三脚猫 c、四脚蛇 d 只，d = 2b。代入头数 a + 2b + c + d = 58 得 a + 4b + c = 58（①），代入脚数 a + 4b + 3c + 4d = 160 得 a + 12b + 3c = 160（②）。",
        "② − ① 得 8b + 2c = 102 ⇒ 4b + c = 51；再把它回代到 ① 得 a = 58 − 51 = 7。独脚兽 7 只。"
      ],
      "scenes": [
        {
          "kind": "result-badges",
    ...
    },
    {
      ...
      "label": "巧解·整体代换",
      "steps": [
        "分析：由 d = 2b 把「1 条双头龙 + 2 条四脚蛇」打包成 4 头 12 脚的一组；独脚兽和三脚猫都是单头动物。对题目做「脚 − 头」：每只独脚兽贡献 0、每只三脚猫贡献 2，打包后的组合贡献 12 − 4 = 8。故 8b + 2c = 160 − 58 = 102，即 4b + c = 51。",
        "代入头数 a + (4b + c) = 58 ⇒ a = 7。答案只取决于 a，不依赖 b、c 具体取值。"
      ],
      "scenes": [
        {
          "kind": "heads-split",
