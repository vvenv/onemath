  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "分析：△ADE 与 △ABC 共顶点 A 及夹角 ∠A，D、E 分别在夹 ∠A 的两条边上，是典型的共角三角形。",
        },
        {
          text: "算比例。D 是 AB 中点 ⇒ AD : AB = 1 : 2；AE : EC = 2 : 1 ⇒ AE : AC = 2 : 3。",
        },
        {
          text: "△ADE : △ABC = (AD · AE) : (AB · AC) = (1 · 2) : (2 · 3) = 1 : 3。",
        },
        {
          text: "△ABC = 12 × 3 = 36。",
          scenes: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          text: "△ABE 与 △ABC 同以 AB 为底 ⇒ △ABE : △ABC = AE : AC = 2 : 3 ⇒ △ABE = (2/3) · △ABC。",
        },
        {
          text: "所以 △ADE = (1/2)·(2/3)·△ABC = △ABC / 3 ⇒ △ABC = 36。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "△ABE = △ABC × 2/3", rhs: "(2/3) △ABC" },
                { lhs: "△ADE = △ABE × 1/2", rhs: "(1/3) △ABC" },
                { lhs: "△ABC", rhs: "36", status: "keep" },
              ],
            },
          ],
        },
