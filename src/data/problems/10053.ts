...
export default {
  ...
  difficulty: "基础",
  question:
    "一列火车长 180 米，以每秒 20 米的速度通过一座长 420 米的大桥。从车头上桥到车尾离桥，一共需要多少秒？",
  figures: [
    {
      svg: svg1,
  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "总路程 = 桥长 + 车长 = 420 + 180 = 600 米，时间 = 600 ÷ 20 = 30 秒。",
          scenes: [
            {
              kind: "svg",
              svg: svg2,
  ...
  variant: {
    question:
      "一列火车通过一座长 500 米的桥需要 40 秒，用同样的速度通过一条长 300 米的隧道需要 28 秒。这列火车的速度和车长各是多少？",
    fields: [
      {
        key: "speed",
        label: "火车速度（米/秒）",
