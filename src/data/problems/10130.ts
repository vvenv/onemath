  ...
  solutions: [
    {
      ...
      steps: [
        ...
        {
          text: "对应边比。△ABE 中对应 ∠AEB 的边是 AB；△DFE 中对应 ∠DEF 的边是 DF。因此 AB : DF = AE : DE。",
        },
        {
          text: "代入数值。AE = 4，DE = AD − AE = 10 − 4 = 6。所以 AB : DF = 4 : 6 = 2 : 3。",
        },
        {
          text: "第四步：AB = 16 ⇒ DF = 16 × 3/2 = 24。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "AE / DE", rhs: "4 / 6 = 2/3" },
