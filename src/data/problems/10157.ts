...
export default {
  ...
  module: "几何",
  difficulty: "进阶",
  question: "如图，一个边长为10厘米的正方形，每条边被三等分。将每个顶点与对边的一个三等分点连接，四条连接线围成一个旋转的四边形（阴影部分）。求阴影部分的面积是多少平方厘米？",
  figures: [
    {
      svg: svg1,
  ...
  variant: {
    question: "一个边长为12厘米的正方形，每条边被三等分。将每个顶点与对边的一个三等分点连接，四条连接线围成一个旋转的四边形（阴影部分）。求阴影部分的面积是多少平方厘米？",
    figures: [
      {
        svg: svg2,
        caption: "边长12cm的正方形，每边三等分，连接点形成内部旋转正方形（阴影）",
