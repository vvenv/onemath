  ...
  "solutions": [
    {
      ...
      "label": "并行安排法",
      "steps": [
        "分析：5 件事有先后约束：烧开水必须等洗水壶完成；沏茶必须等烧开水、洗茶杯、拿茶叶都完成。烧开水时间最长（10 分钟），它一旦启动，其它可以不占水壶/茶杯的事情能同时做。",
        "把烧开水安排在整条时间线的最长段上，把洗茶杯（2 分钟）和拿茶叶（1 分钟）塞到烧水的 10 分钟里同时完成。",
        "总时间 = 洗水壶 1 + 烧开水 10 + 沏茶 1 = 12 分钟。",
        "在烧水的 10 分钟中，2 + 1 = 3 分钟用于准备茶杯和茶叶，仍有 7 分钟空闲但无活可干，这是可以接受的。",
        "所以最少需要 12 分钟。"
      ],
      "scenes": [
        {
