  ...
  "solutions": [
    {
      ...
      "label": "比例法",
      "steps": [
        "分析：以规定到达时间为参照，按 60 米/分走到点时离学校还差 60 × 5 = 300 米；按 80 米/分走到点时则超出学校 80 × 3 = 240 米。两条路径在同一段规定时间内相差 300 + 240 = 540 米，正是速度差 80 − 60 = 20 米/分乘以规定时间。",
        "规定时间 = 540 ÷ 20 = 27 分；距离 = 60 × (27 + 5) = 1920 米（亦可验：80 × (27 − 3) = 1920 米）。"
      ],
      "scenes": [
        {
          "kind": "number-line",
