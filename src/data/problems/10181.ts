          ...
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "总事件数", rhs: "6", status: "keep" },
                { lhs: "有利事件数", rhs: "2（5、6）", status: "keep" },
                { lhs: "概率", rhs: "2 ÷ 6 = 1/3", status: "keep" },
              ],
            },
            {
              kind: "compare-bars",
              rows: [
                { label: "总事件", value: 6, max: 6, tone: "muted" },
                { label: "有利事件", value: 2, max: 6, tone: "primary" },
              ],
            },
          ],
        },
