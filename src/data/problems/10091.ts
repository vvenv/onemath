...
export default {
  ...
  "figures": [
    {
      "svg": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 280 120' font-size='13'><g fill='#1B4F72' text-anchor='middle'><text x='140' y='50'>1, 2, 4, 8, 16, 32, 64, 128, 256</text><text x='140' y='85' font-size='11' fill='#555'>（9 个数，每个用一次，填入 3×3 方格，每行/列/对角线乘积相等）</text></g></svg>",
      "caption": "9 个待填数字",
      "alt": "9 个 2 的幂"
    }
  ],
