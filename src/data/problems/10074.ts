  ...
  "solutions": [
    {
      ...
      "label": "逐村枚举法",
      "steps": [
        "分析：车站只能建在 5 个村之一，总路程公式是 Σ (住户数 × 到车站距离)。直接对 A、B、C、D、E 各算一次后取最小。",
        "五种选址的总路程依次为 620、480、390、540、940（详见 scenes 的 compare-bars），最小值 390 出现在 C。"
      ],
      "scenes": [
        {
          "kind": "compare-bars",
    ...
    },
    {
      ...
      "label": "加权中位数法",
      "steps": [
        "分析：这是经典的“小往大靠”原则：在一维直线上、以住户数为权，总路程在“加权中位数”处取得最小。",
        "总住户数 = 30 + 20 + 40 + 25 + 15 = 130，一半是 65。",
        "从西向东累计住户数：A 到 30；A+B 到 50；A+B+C 到 90（首次 ≥ 65）。",
        "所以加权中位数所在的村就是 C 村，车站应建在 C。",
        "在 C 处的总路程已由枚举法算出为 390 户·千米。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
