...
export default {
  ...
  solutions: [
    ...
    },
    {
      ...
      steps: [
        {
          text: "分析：AGCD 的补集是 AF、CE 切出的三块外围三角形 △ABG + △BFG + △FCG，用坐标直接算出三块即可反求 AGCD。",
        },
        {
          text: "由解法一得 G = (8, 8)。三块三角形的顶点面积（行列式法）：△ABG = (1/2)|0·(12−8) + 12·(8−12) + 8·(12−12)| = 24；△BFG = (1/2)|12·(6−8) + 12·(8−12) + 8·(12−6)| = 12；△FCG = (1/2)|12·(0−8) + 12·(8−6) + 8·(6−0)| = 12。",
        },
        {
          text: "补集合计 24 + 12 + 12 = 48，AGCD = 144 − 48 = 96。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                ...
                { lhs: "△BFG", rhs: "12" },
                { lhs: "△FCG", rhs: "12" },
                { lhs: "AGCD = 144 − (24 + 12 + 12) (验证)", rhs: "96" },
              ],
            },
          ],
        },
