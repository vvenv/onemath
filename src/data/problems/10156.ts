...
export default {
  ...
  module: "计数",
  difficulty: "进阶",
  question: "某公交车站有三路公交车同时发车。1路公交车每8分钟发一班，2路公交车每12分钟发一班，3路公交车每15分钟发一班。问：至少经过多少分钟，这三路公交车会再次同时发车？",
  solutions: [
    {
      key: "lcm",
      label: "最小公倍数法",
  ...
  variant: {
    question: "某公交车站有两路公交车同时发车。A路公交车每6分钟发一班，B路公交车每9分钟发一班。问：至少经过多少分钟，这两路公交车会再次同时发车？",
    fields: [
      {
        key: "minutes",
        label: "分钟数",
