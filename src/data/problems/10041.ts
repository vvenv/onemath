  ...
  "solutions": [
    {
      ...
      "label": "整除特征分析法",
      "steps": [
        "分析：被 5 整除要求个位 B ∈ {0, 5}；被 3 整除要求数字和 2 + A + 7 + B = 9 + A + B 是 3 的倍数。9 已是 3 的倍数，故 A + B 须是 3 的倍数。",
        "分两种情况（详见 scenes）：B = 0 时 A 是 3 的倍数，最大 A = 9，A + B = 9；B = 5 时 A ≡ 1 (mod 3)，最大 A = 7，A + B = 12。取最大得 A + B = 12。"
      ],
      "scenes": [
        {
