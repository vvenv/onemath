  ...
  "solutions": [
    {
      ...
      "label": "燕尾定理 + 巧分中心三角形",
      "steps": [
        "分析：三条塞瓦线 AE、BF、CD 两两相交给出三个交点 G = BF ∩ CD、H = CD ∩ AE、I = AE ∩ BF，围出中心 △GHI。要证 △ABC = 7 · △GHI，直接用坐标法算出三个交点，比手工燕尾更稳。",
        "建系：取 A(0, 1)、B(0, 0)、C(1, 0)，△ABC = 1/2。三条塞瓦线的分点 D(0, 2/3)、E(1/3, 0)、F(2/3, 1/3) 给出三线方程 AE: y = 1 − 3x，BF: y = x/2，CD: y = 2/3 − 2x/3。",
        "两两求交：I = (2/7, 1/7)，G = (4/7, 2/7)，H = (1/7, 4/7)。三点横纵坐标皆为 1/7 的倍数，预示答案与 7 有关。",
        "用行列式公式算 △GHI = (1/2) · |12/49 − 1/49 − 4/49| = 1/14，比原 △ABC = 1/2 小 7 倍，即 △ABC = 7 · △GHI，命题得证。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
