...
export default {
  ...
  "figures": [
    {
      "svg": "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 360 240' font-size='12'><g fill='none' stroke='#1B4F72'><polygon points='40,210 310,210 100,30'/></g><g stroke='#5D6D7E' fill='none'><line x1='100' y1='30' x2='130' y2='210'/><line x1='40' y1='210' x2='240' y2='150'/><line x1='310' y1='210' x2='80' y2='90'/></g><g fill='rgb(169 50 38 / 0.30)' stroke='#A93226'><polygon points='211,159 113,107 126,184'/></g><g fill='#2E86C1'><circle cx='40' cy='210' r='3'/><circle cx='310' cy='210' r='3'/><circle cx='100' cy='30' r='3'/><circle cx='80' cy='90' r='3'/><circle cx='130' cy='210' r='3'/><circle cx='240' cy='150' r='3'/></g><g fill='#1B4F72' text-anchor='middle'><text x='32' y='225'>B</text><text x='318' y='225'>C</text><text x='100' y='22'>A</text><text x='68' y='88'>D</text><text x='130' y='225'>E</text><text x='252' y='146'>F</text><text x='155' y='150'>GHI</text></g></svg>",
  ...
  "solutions": [
    {
      ...
      "steps": [
        ...
        "第七步：△GHI 面积 = (1/2)|x_G(y_H − y_I) + x_H(y_I − y_G) + x_I(y_G − y_H)|= (1/2)|(4/7)(4/7 − 1/7) + (1/7)(1/7 − 2/7) + (2/7)(2/7 − 4/7)|= (1/2)|(4/7)(3/7) + (1/7)(−1/7) + (2/7)(−2/7)|= (1/2)|12/49 − 1/49 − 4/49| = (1/2)·(7/49) = 1/14。",
        "第八步：对比 △ABC = 1/2，比值为 (1/14) / (1/2) = 1/7。",
        "结论：△ABC = 7 × △GHI，命题得证。"
      ],
      "scenes": [
        {
          ...
          "caption": "三个交点都恰好是「七分之若干」的形式，结果 1/7"
        },
        {
          "kind": "result-badges",
          "items": [
