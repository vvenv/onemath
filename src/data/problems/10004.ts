  ...
  "solutions": [
    {
      ...
      "label": "比较法",
      "steps": [
        "分析第二次分配：空出 4 顶帐篷，意味着还可以再住 7 × 4 = 28 人。",
        "把两种情况对比：",
        "第一种：每顶 5 人，多出 14 人（盈）。",
        "第二种：每顶 7 人，缺少 28 人（亏）。",
        "两种方案总人数相差：14 + 28 = 42 人。",
        "每顶帐篷住的人数相差：7 − 5 = 2 人。",
        "帐篷数量：42 ÷ 2 = 21 顶。",
        "总人数：5 × 21 + 14 = 105 + 14 = 119 人。"
      ],
      "scenes": [
        {
          "kind": "heads",
    ...
    },
    {
      ...
      "steps": [
        "设有 x 顶帐篷。",
        "两种方案人数相等：5x + 14 = 7(x − 4)。",
        "展开：5x + 14 = 7x − 28。",
        "移项：14 + 28 = 7x − 5x ⇒ 42 = 2x ⇒ x = 21。",
        "人数：5 × 21 + 14 = 119。"
      ],
      "scenes": [
        {
