...
export default {
  ...
  difficulty: "进阶",
  question:
    "把 1, 2, 3 这 3 个数字填入 3×3 方格，使每行、每列都恰好出现 1, 2, 3 各一次（即 3 阶拉丁方）。此外还要满足以下 5 条不等号约束：(1) (1,1) < (1,2)(2) (2,1) > (2,2)(3) (3,2) < (3,3)(4) (1,3) > (2,3)(5) (2,2) > (3,2)\n请给出满足上述所有条件的填法（可以证明此填法唯一）。",
  figures: [
    {
      svg: svg1,
      caption:
        "3×3 方格及 5 条不等号约束位置（&lt;, &gt; 为行方向；∨ 为列方向，尖端指向较小者）",
      alt: "含不等号的数阵",
    },
  ],
  solutions: [
