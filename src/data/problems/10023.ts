  ...
  "solutions": [
    {
      ...
      "label": "俯视图标数法",
      "steps": [
        "俯视图是 3×3 的正方形，说明地面上 9 个位置都至少放了 1 个小正方体，这是‘地基’。",
        "正视图反映的是‘每一列（从左到右）的最高堆数’：左列最高 3，中列最高 1，右列最高 2。",
        "在俯视图每个格子里写上该位置堆叠的个数。为了让总数最少，每一列只需要一个位置达到该列的最大高度，其余位置尽量填 1。",
        "左列：一个位置填 3，另外两个位置各填 1，小计 3+1+1=5。",
        "中列：三个位置都只需填 1，小计 1+1+1=3。",
        "右列：一个位置填 2，另外两个位置各填 1，小计 2+1+1=4。",
        "最少总数 = 5 + 3 + 4 = 12 个。"
      ],
      "scenes": [
        {
