  ...
  "solutions": [
    {
      ...
      "label": "枚举法",
      "steps": [
        "分析：用序列记录各信封装的信号。按信封 1 装 2、3、4 分三类，每类对剩余 3 个位置继续求全错位数。",
        "每类都是剩余 3 封信的全错位，各有 3 种。",
        "合计 3 + 3 + 3 = 9 种。"
      ],
      "scenes": [
        {
    ...
    },
    {
      ...
      "label": "容斥原理",
      "steps": [
        "分析：总装法 4! = 24。记 A_i 为「第 i 封装对」，需要求至少一封装对的方法数 |A_1 ∪ … ∪ A_4|。",
        "由容斥原理：单集合之和 C(4,1)·3! = 24；两两交集之和 C(4,2)·2! = 12；三个集合交集 4、四个集合交集 1。",
