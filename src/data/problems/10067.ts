  ...
  "solutions": [
    {
      ...
      "label": "枚举法",
      "steps": [
        "按信封1装2/3/4分类，每类剩余3信全错位各有3种，合计 3+3+3=9 种。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
    ...
    },
    {
      ...
      "label": "递推公式法（错排数 D_n）",
      "steps": [
        "错排递推 D_n = (n−1)(D_{n−1}+D_{n−2})：D_1=0, D_2=1, D_3=2, D_4=3×(2+1)=9（与枚举一致）。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
    ...
    },
    {
      ...
      "label": "容斥原理",
      "steps": [
        "容斥：总装法 4!=24，至少一封装对 24−12+4−1=15，全部错 = 24−15=9（与前法一致）。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
