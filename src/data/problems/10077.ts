...
export default {
  ...
  difficulty: "进阶",
  question:
    "某物流公司用 4 辆相同的卡车，在仓库 A 与工地 B 之间不停往返运货。A、B 之间单程行驶 15 分钟（空车返程也 15 分钟）；在 A 装一辆车需 3 分钟，在 B 卸一辆车需 3 分钟；装卸各需一名工人，同一时刻一名工人只能服务一辆车。工人可以留在一个站点固定装卸，也可以跟车往返（跟车途中不计工作时间，到站即可开工）。问至少派多少名工人，就能保证 4 辆车始终不因为等人而停下？",
  figures: [
    {
      svg: svg1,
  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "分析：一辆车一圈 3 + 15 + 3 + 15 = 36 min，4 辆均匀错开后 A、B 两站的到站节拍 = 36 ÷ 4 = 9 min/车。只要每位工人在节拍内处理完一辆就不会被瓶颈住；装/卸各 3 min < 9 min，故 A、B 各 1 人即可，共 2 人。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
