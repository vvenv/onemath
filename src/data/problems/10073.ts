  ...
  "solutions": [
    {
      ...
      "steps": [
        ...
        "按甲时间 vs 乙时间分成两组：第 1 组（甲≤乙）A(3,6)、C(4,7)；第 2 组（甲>乙）B(7,2)、D(5,3)、E(6,4)。",
        "第 1 组按甲升序排：A→C；第 2 组按乙降序排：E→D→B。拼接得总顺序 A → C → E → D → B。",
        "按此顺序逐件推演两台机床的时间安排，乙在时刻 27 完工最后一件 B。最短总工时 = 27 小时。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
