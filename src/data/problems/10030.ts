...
export default {
  ...
  difficulty: "基础",
  question:
    "如图，一个机器零件的横截面由一个长方形和两个凸起的正方形组成。已知长方形的长是 12 厘米，宽是 6 厘米。两个正方形的边长都是 3 厘米。这个横截面的周长是多少厘米？",
  figures: [
    {
      alt: "机器零件横截面示意图",
      ...
      scenes: [
        {
          ...
          added: ["bottom", "left"],
          caption:
            "步骤1：观察凸起的部分（左侧和上方）。目标是将缺口补上，转化为长方形。",
        },
        {
          kind: "pit-diagram",
          removed: [],
          ...
          caption:
            "步骤2：想象把上方凸起的小线段（红色）平移到下方，把左侧凸起的小线段（蓝色）平移到右侧。平移后，图形的周长没有改变，但形状变成了一个规则的大长方形。",
        },
        {
          kind: "svg",
          alt: "平移法补齐后的大长方形示意图",
          caption:
            "平移后，原图形的周长等价于外接大长方形（绿色）的周长：15 × 9 厘米。",
          svg: svg2,
        },
        {
          kind: "compare-bars",
          ...
          caption:
            "平移后得到一个长 12 + 3 = 15 厘米，宽 6 + 3 = 9 厘米的长方形。",
        },
        {
          kind: "result-badges",
          items: [
