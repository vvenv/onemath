  ...
  "solutions": [
    {
      ...
      "label": "等量合并·两溶液法",
      "steps": [
        "分析：10% 与 40% 等质量混合得到 (10 + 40)/2 = 25%，于是原三溶液问题先合并成「25% 与 20% 配 22% 的两溶液问题」。",
        "对合并后的问题用十字交叉：25 − 22 = 3，22 − 20 = 2，25% : 20% = 2 : 3，故 25% 共 600 · 2/5 = 240 克、20% 共 600 · 3/5 = 360 克。",
        "把 240 克 25% 拆回等量的 10% 与 40%，各 120 克。答：10% 120 克、20% 360 克、40% 120 克。"
      ],
      "scenes": [
        {
          "kind": "svg",
