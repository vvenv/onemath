...
export default {
  ...
  solutions: [
          ...
          scenes: [
            {
              ...
              rows: [
                ...
                {
                  lhs: "△DEC = 48 − 12.5 − 10.5 (等积变换：整体减去外围)",
                  rhs: "25",
                },
                {
                  lhs: "△DEF = 25 × (2/5) (答案)",
    ...
    },
    {
      ...
      steps: [
        {
          text: "分析：取 A 作原点、AB 沿 x 轴、AD 沿 y 轴建系：A(0, 0)、B(8, 0)、D(0, 5)、C(8, 7)、E(5, 0)。DF : FC = 2 : 3 ⇒ F = D + (2/5)(C − D) = (16/5, 29/5)。",
          scenes: [],
        },
        {
          text: "行列式公式：△DEF = (1/2)|0·(0 − 29/5) + 5·(29/5 − 5) + (16/5)·(5 − 0)| = (1/2)·20 = 10，与前解一致。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
