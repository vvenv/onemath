  ...
  "solutions": [
    {
      ...
      "label": "余数计算法",
      "steps": [
        "分析：求 1 月 1 日到 10 月 1 日的间隔天数，再对 7 取余数，就能从星期一推出 10 月 1 日是星期几。2024 年是闰年，2 月 29 天。",
        "1 至 9 月天数累加 31 + 29 + 31 + 30 + 31 + 30 + 31 + 31 + 30 = 274 天；274 ÷ 7 = 39 余 1。星期一 + 1 天 = 星期二，故 10 月 1 日是星期二。"
      ],
      "scenes": [
        {
          "kind": "number-grid",
