...
export default {
  ...
  "module": "数论",
  "difficulty": "进阶",
  "question": "有 84 个苹果、126 个梨和 168 个橘子，要把它们分成若干份，每份中苹果、梨、橘子的数量分别相同。最多能分成多少份？每份各有苹果、梨、橘子多少个？",
  "solutions": [
    {
      "key": "gcd-application",
      "label": "最大公约数应用",
  ...
  "variant": {
    "question": "有 60 支铅笔、90 块橡皮和 120 把尺子，要把它们分成若干份，每份中铅笔、橡皮、尺子的数量分别相同。最多能分成多少份？",
    "fields": [
      {
        "key": "parts",
        "label": "最多份数"
