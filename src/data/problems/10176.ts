  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "60 和 84 连续除以 2、2、3，得最大公约数 12，最小公倍数 420。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "60, 84", rhs: "÷ 2 → 30, 42" },
                { lhs: "30, 42", rhs: "÷ 2 → 15, 21" },
                { lhs: "15, 21", rhs: "÷ 3 → 5, 7" },
                { lhs: "最大公约数", rhs: "2 × 2 × 3 = 12", status: "keep" },
                {
                  lhs: "最小公倍数",
                  rhs: "2 × 2 × 3 × 5 × 7 = 420",
                  status: "keep",
          ...
          scenes: [
            {
              ...
              rows: [
                { lhs: "60", rhs: "2² × 3 × 5" },
                { lhs: "84", rhs: "2² × 3 × 7" },
                { lhs: "最大公约数", rhs: "2² × 3 = 12", status: "keep" },
                {
                  lhs: "最小公倍数",
                  rhs: "2² × 3 × 5 × 7 = 420",
                  status: "keep",
