...
export default {
  ...
  difficulty: "进阶",
  question:
    "如图，一串正方形的排列规律是：每个正方形的边长都等于前一个正方形的对角线长。\n\n已知第一个正方形的边长是1厘米，求第十一个正方形的边长是多少厘米？",
  figures: [
    {
      svg: svg1,
  ...
  solutions: [
    {
      ...
      steps: [
        {
          text: "分析：边长为 a 的正方形，其对角线长为 a√2。因此每个正方形的边长都是前一个的 √2 倍。",
          scenes: [],
        },
        {
          text: "这是一个等比数列，首项 a₁ = 1，公比 r = √2。",
          scenes: [],
        },
        {
          text: "第 n 项公式：aₙ = a₁ × r^(n-1) = 1 × (√2)^(n-1)。",
          scenes: [],
        },
        {
          text: "第 11 项：a₁₁ = (√2)^10 = (2^(1/2))^10 = 2^5 = 32（厘米）。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
  ...
  variant: {
    question:
      "一串正方形的排列规律是：每个正方形的边长都等于前一个正方形的对角线长。\n\n已知第一个正方形的边长是2厘米，求第八个正方形的边长是多少厘米？",
    fields: [
      {
        key: "side_length",
        label: "边长（厘米）",
