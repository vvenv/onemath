  ...
  "solutions": [
    {
      ...
      "label": "分类计数法",
      "steps": [
        "分析：5×5 = 25 个格点。对任意两格点，水平距离 dx、垂直距离 dy ∈ [0, 4]，段长 L = √(dx²+dy²)。L 为整数当且仅当 dx²+dy² 是完全平方数。",
        "按 L 值分类搜索可行 (dx, dy)：轴向 (1,0)…(4,0) 与 (0,1)…(0,4) 给 L = 1~4；斜向唯一满足勾股的组合是 (3,4) 与 (4,3)，给 L = 5。",
        "给定方向 (dx, dy) 时，棋盘上的位置数 = (5−dx)(5−dy)。按对称性把两个方向合并：L=1 → 2·4·5 = 40，L=2 → 2·3·5 = 30，L=3 → 2·2·5 = 20，L=4 → 2·1·5 = 10，L=5 → 2·2·1 = 4。",
