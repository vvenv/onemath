...
export default {
  ...
  difficulty: "基础",
  question:
    "用一口平底锅烙饼，锅里一次最多同时烙 2 张饼。每张饼有正反两面，每面都要烙 3 分钟才熟。现在要烙 3 张饼，最少需要多少分钟？",
  figures: [
    {
      svg: svg1,
  ...
  solutions: [
    {
      ...
      label: "交替轮换法",
      steps: [
        "6面÷2×3=9分钟下限。构造：A1+B1(0-3), A2+C1(3-6), B2+C2(6-9)，锅始终满2面，总9分钟最优。",
      ],
      scenes: [
        {
          kind: "equation-list",
    ...
    },
    {
      ...
      label: "下限估计法",
      steps: [
        "下限 = 6÷2×3=9 分钟，交替轮换法可达此下限，故最少用时 9 分钟（与前法一致）。",
      ],
      scenes: [
        {
          kind: "equation-list",
