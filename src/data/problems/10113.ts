  ...
  solutions: [
    {
      ...
      steps: [
        ...
        {
          text: "D 是 BC 中点 ⇒ △ABD 与 △ADC 等底等高，面积都是 24 ÷ 2 = 12。",
          scenes: [],
        },
        {
          text: "看 △ADC，E 是 AC 中点 ⇒ 中线 DE 把 △ADC 分成 △ADE 与 △DEC 两个等面积的三角形，各为 12 ÷ 2 = 6。",
          scenes: [],
        },
        {
          text: "看 △ADE，F 是 AD 中点 ⇒ 中线 EF 把 △ADE 分成 △AEF 与 △DEF 两个等面积的三角形，各为 6 ÷ 2 = 3。",
          scenes: [],
        },
        {
