  ...
  solutions: [
    {
      ...
      steps: [
        ...
        {
          text: "20 ÷ 3 = 6 余 2，正好剩 2，直接写 20 = 3 × 6 + 2。最大乘积 = 3⁶ × 2 = 729 × 2 = 1458。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
    ...
    },
    {
      ...
      steps: [
        {
          text: "分析：为佐证上解，对几种典型拆法做对比（详见 scenes 的 compare-bars）：全 2（10 个）1024、全 4（5 个）1024、全 5（4 个）625、5 个 3 + 1 个 5 得 1215，均不超过 6 个 3 + 1 个 2 = 1458。",
          scenes: [
            {
              kind: "compare-bars",
              rows: [
