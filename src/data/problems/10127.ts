  ...
  solutions: [
    {
      ...
      steps: [
        ...
        {
          text: "附注：另一种看法——由 △AOB : △BOC = OA : OC = 4 : 6 = 2 : 3；再由 △AOD : △COD = OA : OC = 2 : 3 ⇒ △AOD = 9 × 2/3 = 6。",
          scenes: [
            {
              kind: "equation-list",
              rows: [
                { lhs: "△AOB · △COD", rhs: "4 × 9 = 36", badge: "蝴蝶" },
                { lhs: "△BOC · △AOD", rhs: "6 × △AOD" },
                { lhs: "△AOD", rhs: "36 ÷ 6 = 6" },
                { lhs: "ABCD = 4 + 6 + 9 + 6", rhs: "25", badge: "答案" },
              ],
            },
            {
              kind: "compare-bars",
              rows: [
                { label: "△AOB", value: 4, max: 10, tone: "muted" },
