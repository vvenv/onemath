...
export default {
  ...
  difficulty: "挑战",
  question:
    "甲容器有浓度为 12% 的盐水 500 克，乙容器有浓度为 20% 的盐水 300 克。分别从两个容器中各取出等量的一杯盐水进行交换，交换后两个容器中的盐水浓度恰好相等。那么取出的这杯盐水重多少克？",
  solutions: [
    {
      key: "equal_conc",
      label: "最终浓度相等法",
      steps: [
        "最终浓度 = (500×12% + 300×20%) ÷ 800 = 15%，甲盐量增加 75−60=15 克。x·(20%−12%)=15 ⇒ x=187.5 克。",
      ],
      scenes: [
        {
          kind: "svg",
          svg: svg1,
          caption:
            "交换前：甲 500g（12%，含盐 60g），乙 300g（20%，含盐 60g）。",
        },
        {
          kind: "equation-list",
          rows: [
