...
export default {
  ...
  module: "应用题",
  question:
    "甲容器有浓度为 12% 的盐水 500 克，乙容器有浓度为 20% 的盐水 300 克。分别从两个容器中各取出等量的一杯盐水进行交换，交换后两个容器中的盐水浓度恰好相等。\n那么取出的这杯盐水重多少克？",
  solutions: [
    {
      key: "equal_conc",
      label: "最终浓度相等法",
      steps: [
        {
          text: "最终浓度 = (500×12% + 300×20%) ÷ 800 = 15%，甲盐量增加 75−60=15 克。\nx·(20%−12%)=15 ⇒ x=187.5 克。",
          scenes: [
            {
              kind: "svg",
              svg: svg1,
            ...
            },
            {
              ...
              rows: [
                ...
                { lhs: "= (关键)", rhs: "120 ÷ 800 = 15%", status: "keep" },
            ...
            },
            {
              kind: "result-badges",
              items: [
                { icon: "🧪", count: "187.5", label: "取出的盐水", note: "克" },
              ],
