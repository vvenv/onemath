  ...
  "solutions": [
    {
      ...
      "label": "比较法（逐格推出）",
      "steps": [
        "分析：1–9 合计 45，3 行等和得幻和 S = 15。中心 5 与一角 4、一线 6 已给，且标准三阶幻方中心必为 5，恰好吻合；于是反向对角线 6 + 5 + 4 = 15 自动成立。接下来每一行、列只要看有两格已知，就用 15 减去它们得到第 3 格。",
        "按「两格已知 → 第三格 = 15 − 之和」逐格推：第 2 行 9，第 3 列 8，第 3 行中 3，第 2 列上 7，第 1 行左 2。",
