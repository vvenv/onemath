...
export default {
  ...
  "module": "行程",
  "difficulty": "进阶",
  "question": "一列火车通过一座长 600 米的桥需要 50 秒，用同样的速度通过一条长 400 米的隧道需要 40 秒。这列火车的速度和车长各是多少？",
  "figures": [
    {
      "svg": svg1,
      "caption": "火车过桥和过隧道示意图",
  ...
  "variant": {
    "question": "一列火车通过一座长 800 米的桥需要 60 秒，用同样的速度通过一条长 500 米的隧道需要 45 秒。这列火车的速度和车长各是多少？",
    "fields": [
      {
        "key": "speed",
        "label": "火车速度（米/秒）"
