...
export default {
  ...
  "solutions": [
    {
      ...
      "label": "累加法",
      "steps": [
        "分析：立方体有 6 个面，每个面由 4 个顶点围成；每个顶点正好是 3 个面的公共顶点。",
        "把 6 个面上的顶点数字之和加起来，每个顶点被算 3 次，结果 = 3 × (1+2+…+8) = 3 × 36 = 108。",
        "另一方面，6 个面和各为 S，总和 = 6S。",
        "所以 6S = 108，S = 18。",
        "结论：若这样填法存在，每面和必为 18。存在性：把 8 个数按『对顶点和 = 9』成对摆放（1↔8, 2↔7, 3↔6, 4↔5，每对占立方体对角线两端），即可验证每面和都是 18。"
      ],
      "scenes": [
        {
          "kind": "equation-list",
  ...
  "variant": {
    "question": "把 1–8 填入立方体 8 顶点使每面 4 顶点和相等。一对对角线上两端顶点的数字之和必定等于几？",
    "fields": [
      {
        "key": "diag",
        "label": "对角两端之和",
